...
CREATE TABLE public.profiles (
  ...
  profession TEXT,
  phone TEXT,
  membership_status TEXT DEFAULT 'pending' CHECK (membership_status IN ('pending', 'active', 'expired', 'cancelled')),
...
BEGIN
  -- Insert profile
  INSERT INTO public.profiles (user_id, first_name, last_name, country, profession, phone)
  VALUES (
    NEW.id,
  ...
  -- Insert default role (estudiante)
