...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    const { userId, userName, planName, amount, currency, expiresAt }: PaymentConfirmationRequest = await req.json();

    if (!userId || !userName || !planName) {
      return new Response(
    ...
    const emailHtml = `
      ...
      <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none;">
          <h2 style="color: #2ecc71; margin-top: 0;">¡Pago Confirmado! ✅</h2>
          
          <p>Hola <strong>${userName}</strong>,</p>
          
          <p>Tu pago ha sido procesado exitosamente. ¡Ya tienes acceso completo a EDAN!</p>
          
          <div style="background: #f8f9fa; border-radius: 8px; padding: 20px; margin: 20px 0;">
            <h3 style="margin-top: 0; color: #1a1a2e;">Detalles de tu compra:</h3>
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr>
                ...
                <td style="padding: 8px 0; border-bottom: 1px solid #eee; text-align: right;">$${amount} ${currency}</td>
              </tr>
              <tr>
                <td style="padding: 8px 0;"><strong>Válido hasta:</strong></td>
          ...
          <div style="background: #d4edda; border: 1px solid #28a745; border-radius: 5px; padding: 15px; margin: 20px 0;">
            <p style="margin: 0; color: #155724;">
              <strong>¡Ya puedes comenzar!</strong><br>
              Inicia sesión y explora todos los cursos disponibles en tu plan.
            </p>
          </div>
    ...
    const emailResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: [userEmail],
        subject: "¡Pago confirmado! Tu membresía EDAN está activa 🎓",
        html: emailHtml,
      }),
    });
